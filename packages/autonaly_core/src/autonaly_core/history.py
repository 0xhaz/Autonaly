...
EVENTS: tuple[CrisisEvent, ...] = (
    ...
    CrisisEvent(
        "smoot-hawley",
        "Smoot-Hawley tariffs and the trade collapse",
        1930,
        1934,
        ("USA",),
        "financial",
    ...
    CrisisEvent(
        ...
        "Iranian oil nationalization and embargo",
        1951,
        1954,
        ("IRN", "GBR"),
        "embargo",
    ...
    CrisisEvent(
        ...
        "A blockade can be a signalling instrument: narrow in scope, total in implication.",
    ),
    CrisisEvent(
        "suez-1967",
        "Suez Canal closed for eight years",
        1967,
        1975,
        ("EGY", "ISR"),
        "canal_closure",
    ...
    CrisisEvent(
        "biafra",
        "Nigerian civil war and Biafra blockade",
        1967,
        1970,
        ("NGA",),
        "blockade",
    ...
    CrisisEvent(
        "chile-copper",
        "Chilean copper nationalization and coup",
        1971,
        1974,
        ("CHL",),
        "revolution",
    ...
    CrisisEvent(
        ...
        ("wheat", "maize"),
        outcomes=(Outcome("US wheat", "roughly tripled", "mid-1972 – early 1974"),),
    ),
    CrisisEvent(
        "opec-embargo",
        "OPEC oil embargo",
        ...
        outcomes=(
            Outcome(
                ...
                "roughly quadrupled, ~$3 to ~$12 per barrel",
                "Oct 1973 – Jan 1974",
            ),
        ),
    ),
    ...
    CrisisEvent(
        ...
        outcomes=(
            Outcome(
                "Crude oil", "more than doubled, ~$13 to over $30 per barrel", "1979 – mid-1980"
            ),
        ),
    ),
    CrisisEvent(
        "us-grain-embargo",
        "US grain embargo on the USSR",
        1980,
        1981,
        ("USA", "RUS"),
        "embargo",
    ...
    CrisisEvent(
        "gulf-war",
        "Iraqi invasion of Kuwait and Gulf War",
        1990,
        1991,
        ("IRQ", "KWT"),
        "war",
    ...
    CrisisEvent(
        "russia-default-1998",
        "Russian default and devaluation",
        1998,
        1999,
        ("RUS",),
        "financial",
    ...
    CrisisEvent(
        "zimbabwe-land",
        "Zimbabwe land seizures and agricultural collapse",
        2000,
        2008,
        ("ZWE",),
        "revolution",
    ...
    CrisisEvent(
        ...
        "Mega-disasters redraw charts — literally: the channel a port relied on can move.",
        (),
        ("malacca",),
    ),
    CrisisEvent(
    ...
    CrisisEvent(
        "food-crisis-2008",
        "Global food price crisis and export bans",
        2007,
        2008,
        ("VNM", "IND", "ARG", "EGY"),
        "export_ban",
        ...
        ("rice", "wheat"),
        outcomes=(Outcome("Rice", "roughly tripled in about six months", "late 2007 – mid 2008"),),
    ),
    CrisisEvent(
        "georgia-war",
        "Russo-Georgian War",
    ...
    CrisisEvent(
        ...
        ("wheat", "barley"),
        outcomes=(Outcome("Wheat futures", "up on the order of 60–80%", "Jun – Aug 2010"),),
    ),
    CrisisEvent(
        "china-rare-earths",
        ...
        outcomes=(
            Outcome(
                ...
                "multiplied severalfold — some oxides more than tenfold — "
                "then collapsed as new supply arrived",
                "2010 – 2013",
            ),
        ),
    ),
    ...
    CrisisEvent(
        "fukushima",
        "Tōhoku earthquake and Fukushima disaster",
        2011,
        2012,
        ("JPN",),
        "disaster",
        ...
        outcomes=(
            Outcome(
                "Japanese auto output",
                "fell by around half at the trough as single-source parts ran out",
                "Apr – Jun 2011",
            ),
            Outcome(
                "Japanese LNG imports",
                "rose sharply for years as the nuclear fleet shut down",
                "2011 – 2014",
            ),
        ),
    ),
    CrisisEvent(
        "thai-floods",
        "Thailand floods and the hard-drive shortage",
        2011,
        2012,
        ("THA",),
        "disaster",
        ...
        outcomes=(
            Outcome(
                "Hard-drive prices",
                "roughly doubled, staying elevated for about a year",
                "Q4 2011 – 2012",
            ),
        ),
    ),
    ...
    CrisisEvent(
        "iran-sanctions-2012",
        "Iran oil sanctions and SWIFT cutoff",
        2012,
        2015,
        ("IRN",),
        "sanctions",
    ...
    CrisisEvent(
        "crimea",
        "Annexation of Crimea and Donbas war",
        2014,
        2021,
        ("UKR", "RUS"),
        "sanctions",
    ...
    CrisisEvent(
        "yemen-war",
        "Yemen war and Red Sea insecurity",
        2015,
        None,
        ("YEM", "SAU"),
        "war",
    ...
    CrisisEvent(
        "nk-sanctions",
        "North Korea maximum-pressure sanctions",
        2017,
        None,
        ("PRK", "CHN"),
        "sanctions",
    ...
    CrisisEvent(
        ...
        outcomes=(
            Outcome(
                "Brent crude",
                "jumped ~15% on reopen — the largest single-day move since "
                "1991 — and retraced within weeks",
                "Sep 2019",
            ),
        ),
    ),
    CrisisEvent(
        "japan-korea-chips",
        "Japan–Korea semiconductor materials dispute",
        2019,
        2023,
        ("JPN", "KOR"),
        "export_ban",
    ...
    CrisisEvent(
        "venezuela-collapse",
        "Venezuelan oil collapse and sanctions",
        2017,
        None,
        ("VEN",),
        "sanctions",
    ...
    CrisisEvent(
        ...
        outcomes=(
            Outcome(
                "Container spot rates (Drewry WCI)",
                "rose roughly fivefold to records above $10,000/FEU",
                "2020 – late 2021",
            ),
            Outcome(
                "Chip lead times",
                "stretched beyond 20 weeks at the peak of the shortage",
                "2021 – 2022",
            ),
        ),
    ),
    ...
    CrisisEvent(
        ...
        outcomes=(
            Outcome(
                "Suez transit queue",
                "several hundred ships waiting; schedule disruption rippled for months",
                "Mar – Jun 2021",
            ),
            Outcome(
                "Crude oil",
                "moved a few percent on the headlines and retraced within days",
                "Mar 2021",
            ),
        ),
    ),
    ...
    CrisisEvent(
        ...
        outcomes=(
            ...
            Outcome(
                "European gas (TTF)",
                "peaked near €340/MWh, an order of magnitude above pre-crisis norms",
                "Aug 2022",
            ),
            Outcome(
                "Potash and urea", "multi-year highs before retracing as flows rerouted", "2022"
            ),
        ),
    ),
    CrisisEvent(
    ...
    CrisisEvent(
        ...
        ("lng", "lpg", "maize", "soybeans"),
        ("panama",),
        outcomes=(
            Outcome(
                "Transit slot auctions",
                "premiums reached millions of dollars per passage at the squeeze's peak",
                "late 2023",
            ),
        ),
    ),
    CrisisEvent(
        "gallium-germanium",
        "China's gallium and germanium controls",
        2023,
        None,
        ("CHN",),
        "export_ban",
    ...
    CrisisEvent(
        "nagorno-karabakh",
        "Second Nagorno-Karabakh war and Lachin blockade",
        2020,
        2023,
        ("ARM", "AZE"),
        "war",
    ...
    CrisisEvent(
        "niger-coup",
        "Niger coup and uranium suspension",
        2023,
        2024,
        ("NER", "FRA"),
        "revolution",
    ...
    CrisisEvent(
        "myanmar-coup",
        "Myanmar coup and rare-earth belt",
        2021,
        None,
        ("MMR", "CHN"),
        "revolution",
    ...
    CrisisEvent(
        ...
        "Black Sea grain corridor and its collapse",
        2022,
        2023,
        ("UKR", "RUS", "TUR"),
        "blockade",
    ...
    CrisisEvent(
        "vale-dams",
        "Vale dam disasters and the iron-ore squeeze",
        2015,
        2019,
        ("BRA",),
        "disaster",
    ...
    CrisisEvent(
        "aus-china-trade",
        "China's trade measures against Australia",
        2020,
        2023,
        ("AUS", "CHN"),
        "sanctions",
    ...
    CrisisEvent(
        "tanker-reflagging",
        "Tanker war reflagging operation",
        1987,
        1988,
        ("KWT", "USA", "IRN"),
        "war",
    ...
    CrisisEvent(
        "bangladesh-cyclone",
        "Cyclone Bhola and Bangladesh's independence war",
        1970,
        1971,
        ("BGD", "PAK"),
        "disaster",
    ...
    CrisisEvent(
        "sudan-oil-split",
        "South Sudan secession and the oil shutdown",
        2011,
        2013,
        ("SDN", "SSD"),
        "revolution",
    ...
    CrisisEvent(
        "vietnam-war",
        "Vietnam War and the mining of Haiphong",
        1964,
        1975,
        ("VNM",),
        "war",
    ...
    CrisisEvent(
        "uk-miners",
        "UK miners' strikes and the Three-Day Week",
        1972,
        1974,
        ("GBR",),
        "strike",
    ...
    CrisisEvent(
        "apartheid-sanctions",
        "Apartheid sanctions and disinvestment",
        1985,
        1991,
        ("ZAF",),
        "sanctions",
    ...
    CrisisEvent(
        "za-unrest-2021",
        "South African unrest and the Transnet cyberattack",
        2021,
        2021,
        ("ZAF",),
        "strike",
    ...
    CrisisEvent(
        "civ-cocoa",
        "Ivorian post-election crisis and cocoa ban",
        2010,
        2011,
        ("CIV",),
        "export_ban",
    ...
    CrisisEvent(
        "guinea-coup",
        "Guinean coup and the bauxite scare",
        2021,
        2022,
        ("GIN",),
        "revolution",
        ...
        outcomes=(
            Outcome(
                "Alumina", "rose about 10% within days of the coup before retracing", "Sep 2021"
            ),
        ),
    ),
    CrisisEvent(
        "mozambique-lng",
        "Cabo Delgado insurgency and the LNG halt",
        2021,
        2024,
        ("MOZ",),
        "war",
    ...
    CrisisEvent(
        "western-sahara",
        "Green March and the Western Sahara war",
        1975,
        1991,
        ("MAR",),
        "war",
    ...
    CrisisEvent(
        ...
        "Argentina's export-restriction era",
        2006,
        2015,
        ("ARG",),
        "export_ban",
    ...
    CrisisEvent(
        ...
        outcomes=(
            Outcome(
                "Barge freight (St. Louis)",
                "spiked to several times the seasonal norm at harvest peak",
                "Sep – Oct 2022",
            ),
        ),
    ),
    ...
    CrisisEvent(
        ...
        outcomes=(
            Outcome(
                "Magnesium",
                "roughly quintupled as smelters idled, alarming European carmakers",
                "Sep – Oct 2021",
            ),
        ),
    ),
